                ...
                <div className='flex-1 p-8 bg-white border rounded-lg border-stone-100 py-7'>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-gray-600 max-w-[700px] mt-1'>
                            {
                                isEdit
                                    ? <textarea onChange={(e) => setProfileData(prev => ({ ...prev, about: e.target.value }))} type='text' className='w-full p-2 outline-primary' rows={8} value={profileData.about} />
                                    : profileData.about
                            }
                        </p>
                    </div>
...

                    {
                        isEdit
                            ...
                            : <button onClick={() => setIsEdit(prev => !prev)} className='px-4 py-1 mt-5 text-sm transition-all border rounded-full border-primary hover:bg-primary hover:text-white'>Edit</button>
                    }
